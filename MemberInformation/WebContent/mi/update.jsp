...
<div class=update>
	...
	<form action="./update" method="post">
		...
		<p>
			名前 <input type="text" name="name" class="namae" value=${member.name }>
		</p>
		<p>
			年齢 <input type="text" name="age" class="toshi" value=${member.age }>
		</p>

		<p>
			生年月日 <select name="birth_year" class="nenn">
			...
			</select> <select name="birth_month" class="getsu">
			...
			</select> <select name="birth_day" class="nichi">
		...
		<input type="submit" name="henkou" class="henkou" value="変更">
